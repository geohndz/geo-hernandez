    ...
    >
      ...
      {controls ? (
        <button
          ...
          className="press-scale pointer-events-auto absolute z-[2] flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-[var(--line)] text-white backdrop-blur-[6px] hover:bg-[var(--line-strong)]"
