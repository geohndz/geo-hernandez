...
export const chipCategoryHover = {
  ...
  orange:
    "transition-[border-color,background-color,color] duration-500 group-hover:border-[#f59e4a] group-hover:bg-[#f59e4a] group-hover:text-[#1a1008]",
  red: "transition-[border-color,background-color,color] duration-500 group-hover:border-[#f07171] group-hover:bg-[#f07171] group-hover:text-[#1a0808]",
  navy:
    "transition-[border-color,background-color,color] duration-500 group-hover:border-[#6b8cff] group-hover:bg-[#6b8cff] group-hover:text-[#0a1020]",
  ice: "transition-[border-color,background-color,color] duration-500 group-hover:border-[#5ec8e0] group-hover:bg-[#5ec8e0] group-hover:text-[#061418]",
  green:
    "transition-[border-color,background-color,color] duration-500 group-hover:border-[#4ade80] group-hover:bg-[#4ade80] group-hover:text-[#06140c]",
  yellow:
    "transition-[border-color,background-color,color] duration-500 group-hover:border-[#f5c84a] group-hover:bg-[#f5c84a] group-hover:text-[#1a1408]",
  blue: "transition-[border-color,background-color,color] duration-500 group-hover:border-[#6b8cff] group-hover:bg-[#6b8cff] group-hover:text-[#0a1020]",
  teal: "transition-[border-color,background-color,color] duration-500 group-hover:border-[#2dd4bf] group-hover:bg-[#2dd4bf] group-hover:text-[#061412]",
} as const;
