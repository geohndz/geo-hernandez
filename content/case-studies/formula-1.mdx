...
disclaimer: An unaffiliated concept project. Formula 1, team, and driver marks belong to their owners and are used here to illustrate a design exploration.
toc:
...
<Figure src="/media/formula-1/process/window-chrome.png" alt="Four leaderboard chrome iterations, from a sharp navy frame to a rounded window with a top bar and inset content" caption="The leaderboard, four chrome passes in. Later versions keep the identity and give the content more of the frame." />
